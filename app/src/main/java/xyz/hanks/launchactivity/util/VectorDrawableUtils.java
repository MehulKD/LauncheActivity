...
public class VectorDrawableUtils {
   /* public static Drawable getMenuDrawable(Context context){
    ...
    public static Drawable getShareDrawable(Context context){
        return VectorDrawableCompat.create(context.getResources(), R.drawable.ic_share_white_24dp, context.getTheme());
    }
    public static Drawable getMoneyDrawable(Context context){
        return VectorDrawableCompat.create(context.getResources(), R.drawable.ic_attach_money_white_24dp, context.getTheme());
    }*/
}
